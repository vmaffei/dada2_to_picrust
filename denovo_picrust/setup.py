...
setup(name='denovo_picrust',
      ...
      license='GNU GPL V3',
      scripts=['denovo_picrust/denovo_picrust.py','denovo_picrust/gap_trimmer.py'],
      ...
      dependency_links=['https://github.com/picrust/picrust//tarball/master#egg=package-1.1'],
      zip_safe=True)
