## PICRUSt2 now available
**Please note that the functions performed by this pipeline have been subsumed into PICRUSt2** (https://github.com/picrust/picrust2), which performs functional predictions for amplicon sequence variants generated by any read processing algorithm. A QIIME2 plugin and plugin-tutorial for PICRUSt2 is available (https://github.com/picrust/picrust2/wiki/q2-picrust2-Tutorial). Detailed information on the PICRUSt2 workflow may be found here (https://github.com/picrust/picrust2/wiki). **Please defer to PICRUSt2 for any future ASV->PICRUSt needs** as PICRUSt2 has undergone much more rigorous validation and includes a new, expanded reference database.

### (Legacy) DADA2 -> PICRUSt via ASR (v2.4)
